...
modelSrcWeights=  'simulation/src/RLAlgorithm/Algorithm/QTOpt/Distributed Qt-Opt/saved_model/Weights/TEST/FullState'
...
start_new_thread(bellmannUpdater.start, ("Thread-3",1  ))
start_new_thread(bellmannUpdater.start, ("Thread-4",1  ))
start_new_thread(bellmannUpdater.start, ("Thread-5",1  ))
